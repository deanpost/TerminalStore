...
while True:
  ...
  #/install commands 
    ...
    #kakoune
        ...
        os.system ('sudo bash kakoune.sh')
        print("Done!")

    #helix
    elif (usrinp == "/install emacs-nox"):
        print("Installing Emacs-nox...")
        os.system ('sudo bash helix.sh')
        print("Done!")
    ...
    #pianobar
        ...
        os.system ('sudo bash pianobar.sh')
        print("Done!")
        #needs tbd
    ...
    #somafm-cli
        ...
        os.system ('sudo bash somafm-cli.sh')
        print("Done!")
    ...
    #NCurses Music Player Client (Plus Plus)
        ...
        os.system ('sudo bash ncmpcpp.sh')
        print("Done!")
    ...
    #musikcube
        ...
        os.system ('sudo bash musikcube.sh')
        print("Done!")
    ...
    #RADIOACTIVE
        ...
        os.system ('sudo bash radio-active.sh')
        print("Done!")

    #youtube-dl
    elif (usrinp == "/install youtube-dl"):
        print("Installing youtube-dl...")
        os.system ('sudo bash youtube-dl.sh')
        print("Done!")
